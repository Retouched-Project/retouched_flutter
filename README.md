...
- ~~When closing a game from the PC while the context menu is open while in the game session, the app won't go back to the games list and will get stuck.~~ (Fixed in v1.0.3)
